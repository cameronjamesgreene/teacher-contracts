...
SYSTEM = (
    ...
    "INCORPORATION BY REFERENCE COUNTS. These contracts routinely adopt an external "
    "document instead of reprinting it — a state code of ethics, a district salary "
    "schedule, a board policy. When a question asks whether the document contains, "
    "references, includes or provides something, a clear reference to it IS a \"yes\"; the "
    "provision does not have to be reproduced in full. Answer the question exactly as it is "
    "worded and do not impose a stricter standard than it states.\n"
    "Reserve \"no\" for the document affirmatively stating the thing does NOT exist or does "
    "not apply. If the topic simply never comes up, that is \"not_discussed\", not \"no\".\n"
