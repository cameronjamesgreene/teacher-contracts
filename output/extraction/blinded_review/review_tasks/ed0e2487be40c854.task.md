# Blinded contract-answer review: ed0e2487be40c854
...
## Question
- ID: `conduct_acceptable_use_006`
Does the document include acceptable-use, email, internet, or network technology rules for employees?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/ed0e2487be40c854.response.json`
```json
{
  "review_id": "ed0e2487be40c854",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
