# Blinded contract-answer review: b575676fee250803
...
## Question
- ID: `conduct_outside_employment_001`
Does the document restrict outside employment, tutoring, or conflicts of interest?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/b575676fee250803.response.json`
```json
{
  "review_id": "b575676fee250803",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
