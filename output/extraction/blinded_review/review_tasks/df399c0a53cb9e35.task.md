# Blinded contract-answer review: df399c0a53cb9e35
...
## Question
- ID: `pay_experience_credit_outofstate_015`
Does the document specify how out-of-state teaching experience is credited for salary placement?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/df399c0a53cb9e35.response.json`
```json
{
  "review_id": "df399c0a53cb9e35",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
