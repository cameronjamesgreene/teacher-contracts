# Blinded contract-answer review: 0548c05f96b92634
...
## Question
- ID: `conduct_ethics_002`
Does the document include a code of ethics, standards of conduct, or professional responsibility rules?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/0548c05f96b92634.response.json`
```json
{
  "review_id": "0548c05f96b92634",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
