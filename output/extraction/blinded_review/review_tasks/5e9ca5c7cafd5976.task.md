# Blinded contract-answer review: 5e9ca5c7cafd5976
...
## Question
- ID: `workload_meetings_limits_008`
Does the document limit required faculty, staff, department, or PLC meetings?

## Candidate A
- Answer: yes
- Evidence: "Teachers may be required to attend professional activities to be held after the dismissal of students which shall be jointly planned and scheduled by the Administration and representatives selected by the faculty at each work site. These activities shall not exceed between ten (10) and thirteen (13) hours per year."
- Page: 20
...
`output/fts_experiment/paired_manchester/review_tasks_top8/5e9ca5c7cafd5976.response.json`
```json
{
  "review_id": "5e9ca5c7cafd5976",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
