# Blinded contract-answer review: 89d7adfd7053f4cf
...
## Question
- ID: `pay_hardtostaff_stem_010`
Does the document provide additional pay, stipends, or salary differentials for teachers in STEM subjects?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/89d7adfd7053f4cf.response.json`
```json
{
  "review_id": "89d7adfd7053f4cf",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
