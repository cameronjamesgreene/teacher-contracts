# Blinded contract-answer review: f166a9f6b1e70a31
...
## Question
- ID: `pay_performance_pay_006`
Does the document include performance pay, merit pay, or evaluation-based compensation?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/f166a9f6b1e70a31.response.json`
```json
{
  "review_id": "f166a9f6b1e70a31",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
