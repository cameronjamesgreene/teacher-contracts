# Blinded contract-answer review: 8d0333ff4ea306af
...
## Question
- ID: `benefits_health_employee_premium_003`
What employee health insurance premium or contribution is stated?
...
## Candidate B
- Answer: 50% of the District’s share plus the regular employee share (for job sharers).
- Evidence: The teachers’ share will be 50% of the District’s share plus the regular employee share.
- Page: 57
...
`output/fts_experiment/paired_manchester/review_tasks_top8/8d0333ff4ea306af.response.json`
```json
{
  "review_id": "8d0333ff4ea306af",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
