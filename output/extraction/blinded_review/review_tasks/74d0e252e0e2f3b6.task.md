# Blinded contract-answer review: 74d0e252e0e2f3b6
...
## Question
- ID: `benefits_retiree_012`
Does the document provide retiree health, dental, life, or other post-employment benefits?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/74d0e252e0e2f3b6.response.json`
```json
{
  "review_id": "74d0e252e0e2f3b6",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
