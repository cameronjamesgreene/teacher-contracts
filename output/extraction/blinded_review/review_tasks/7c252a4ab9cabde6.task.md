# Blinded contract-answer review: 7c252a4ab9cabde6
...
## Question
- ID: `class_secondary_max_003`
What middle or high school class-size maximums or targets are stated?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/7c252a4ab9cabde6.response.json`
```json
{
  "review_id": "7c252a4ab9cabde6",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
