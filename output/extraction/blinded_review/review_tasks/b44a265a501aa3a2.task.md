# Blinded contract-answer review: b44a265a501aa3a2
...
## Question
- ID: `benefits_disability_009`
Does the document mention short-term or long-term disability coverage?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/b44a265a501aa3a2.response.json`
```json
{
  "review_id": "b44a265a501aa3a2",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
