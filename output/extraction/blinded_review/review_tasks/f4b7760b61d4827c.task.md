# Blinded contract-answer review: f4b7760b61d4827c
...
## Question
- ID: `class_overage_remedy_004`
Does the document provide remedies when class-size limits are exceeded?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/f4b7760b61d4827c.response.json`
```json
{
  "review_id": "f4b7760b61d4827c",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
