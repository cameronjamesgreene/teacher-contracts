# Blinded contract-answer review: 13285126dbc5488b
...
## Question
- ID: `evaluation_ratings_005`
What rating categories or performance levels are used?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/13285126dbc5488b.response.json`
```json
{
  "review_id": "13285126dbc5488b",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
