# Blinded contract-answer review: 7cb608b0a8ab0be8
...
## Question
- ID: `workload_prep_guarantee_003`
Does the document guarantee teacher planning or preparation time?

## Candidate A
- Answer: yes
- Evidence: "The Board shall make every reasonable effort to provide all teachers in the junior and senior high schools, in addition to their lunch period, with daily preparation time consisting of one (1) class period during which they will not be assigned to any other duties."
- Page: 21

## Candidate B
- Answer: yes
- Evidence: The Board shall make every reasonable effort to provide all teachers in the junior and senior high schools... with daily preparation time... All Elementary teachers will receive five (5) preparatory periods per week...
- Page: 20
...
`output/fts_experiment/paired_manchester/review_tasks_top8/7cb608b0a8ab0be8.response.json`
```json
{
  "review_id": "7cb608b0a8ab0be8",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
