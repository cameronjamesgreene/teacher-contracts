# Blinded contract-answer review: aec840d268714ed3
...
## Question
- ID: `conduct_drug_alcohol_003`
Does the document include drug-free workplace, alcohol, or substance-abuse rules?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/aec840d268714ed3.response.json`
```json
{
  "review_id": "aec840d268714ed3",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
