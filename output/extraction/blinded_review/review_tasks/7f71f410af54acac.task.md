# Blinded contract-answer review: 7f71f410af54acac
...
## Question
- ID: `safety_weapons_008`
Does the document state employee obligations or restrictions related to weapons on school property?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/7f71f410af54acac.response.json`
```json
{
  "review_id": "7f71f410af54acac",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
