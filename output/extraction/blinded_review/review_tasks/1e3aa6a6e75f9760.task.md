# Blinded contract-answer review: 1e3aa6a6e75f9760
...
## Question
- ID: `safety_health_committee_001`
Does the document include health and safety provisions or a safety committee?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/1e3aa6a6e75f9760.response.json`
```json
{
  "review_id": "1e3aa6a6e75f9760",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
