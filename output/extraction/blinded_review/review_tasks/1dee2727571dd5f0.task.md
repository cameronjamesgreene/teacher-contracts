# Blinded contract-answer review: 1dee2727571dd5f0
...
## Question
- ID: `pay_cost_of_living_007`
Does the document specify across-the-board raises or COLA percentages?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/1dee2727571dd5f0.response.json`
```json
{
  "review_id": "1dee2727571dd5f0",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
