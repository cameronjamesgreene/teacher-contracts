# Blinded contract-answer review: a006495541f1dfd7
...
## Question
- ID: `pay_performance_pay_007`
How are teachers evaluated for purposes of performance-based pay eligibility?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/a006495541f1dfd7.response.json`
```json
{
  "review_id": "a006495541f1dfd7",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
