# Blinded contract-answer review: 3bdceb17268258ac
...
## Question
- ID: `safety_remove_student_004`
Does the document state a teacher's authority to remove a student from class?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/3bdceb17268258ac.response.json`
```json
{
  "review_id": "3bdceb17268258ac",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
