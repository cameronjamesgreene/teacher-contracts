# Blinded contract-answer review: ab086f0237e192a7
...
## Question
- ID: `evaluation_observation_duration_004`
Does the document specify observation duration or minimum length?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/ab086f0237e192a7.response.json`
```json
{
  "review_id": "ab086f0237e192a7",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
