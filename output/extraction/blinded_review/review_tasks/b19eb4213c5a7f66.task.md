# Blinded contract-answer review: b19eb4213c5a7f66
...
## Question
- ID: `class_size_limits_001`
Does the document include class-size limits, caps, goals, or review procedures?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/b19eb4213c5a7f66.response.json`
```json
{
  "review_id": "b19eb4213c5a7f66",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
