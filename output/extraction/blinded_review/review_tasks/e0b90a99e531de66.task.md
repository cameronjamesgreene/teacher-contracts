# Blinded contract-answer review: e0b90a99e531de66
...
## Question
- ID: `conduct_social_media_005`
Does the document regulate employee social media use?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/e0b90a99e531de66.response.json`
```json
{
  "review_id": "e0b90a99e531de66",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
