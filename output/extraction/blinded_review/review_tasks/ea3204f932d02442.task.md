# Blinded contract-answer review: ea3204f932d02442
...
## Question
- ID: `benefits_vision_007`
Does the document state that vision or optical insurance is available?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/ea3204f932d02442.response.json`
```json
{
  "review_id": "ea3204f932d02442",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
