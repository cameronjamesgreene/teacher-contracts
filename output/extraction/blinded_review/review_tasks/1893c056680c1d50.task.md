# Blinded contract-answer review: 1893c056680c1d50
...
## Question
- ID: `evaluation_student_growth_006`
Does the evaluation use student growth, test scores, value-added, or student outcomes?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/1893c056680c1d50.response.json`
```json
{
  "review_id": "1893c056680c1d50",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
