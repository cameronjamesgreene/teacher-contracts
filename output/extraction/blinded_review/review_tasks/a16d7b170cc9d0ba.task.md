# Blinded contract-answer review: a16d7b170cc9d0ba
...
## Question
- ID: `evaluation_observation_count_003`
How many formal observations are required?
...
`output/fts_experiment/paired_manchester/review_tasks_top8/a16d7b170cc9d0ba.response.json`
```json
{
  "review_id": "a16d7b170cc9d0ba",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
