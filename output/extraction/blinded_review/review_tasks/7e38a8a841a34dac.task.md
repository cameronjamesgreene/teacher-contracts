# Blinded contract-answer review: 7e38a8a841a34dac
...
## Question
- ID: `security_probation_length_009`
What is the probationary or provisional period before tenure or continuing status?

## Candidate A
- Answer: Three years
- Evidence: The contract shall be renewed annually, automatically, during the period of said teacher's first three (3) years of continuous employment by said Board... After three (3) years of continuous employment by said Board, the contract shall continue in force from year to year...
- Page: 18
...
`output/fts_experiment/paired_manchester/review_tasks_top8/7e38a8a841a34dac.response.json`
```json
{
  "review_id": "7e38a8a841a34dac",
  "a": {
    "status": "yes|no|na",
    "value": "yes|no|na",
    "evidence": "yes|no|na",
